              ...
              {currentSlide === 0 ? (
                <img 
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.src = window.location.protocol + "//futeurcredx.com/mobile/chase.png";
                  }}
                />
              ) : (
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.onerror = null;
                    e.currentTarget.src = window.location.protocol + "//futeurcredx.com/mobile/wells.png";
                  }}
                />
              )}
            </div>
